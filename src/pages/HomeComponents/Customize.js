    ...
    return (
        <div className=''>
            ...
            <div className="grid grid-cols-1 lg:px-10 lg:grid-cols-3 gap-6">
                <div class="card w-96 mx-auto hover:-translate-y-6 hover:scale-105 hover:shadow-lg duration-700 h-[470px] rounded-none text-white bg-[url('https://i.ibb.co/WxBQZH1/part1.jpg')] ">
                ...
                <div class="card w-96 mx-auto hover:-translate-y-6 hover:scale-105 hover:shadow-lg duration-700 h-[470px] rounded-none text-white bg-[url('https://i.ibb.co/85ZcSgF/part2.jpg')] ">
                    <div class="card-body z-10">
