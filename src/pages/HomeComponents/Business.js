            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-16 px-6 lg:px-20 bg-[url('/public/images/banner/b2.jpg')]   bg-no-repeat bg-cover bg-fixed">
                <div className="card ">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <h2 className="card-title text-primary">Countries</h2>
                    </div>
                </div>
                <div className="card ">
                    <figure className="px-10 pt-10">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <h2 className="card-title text-primary">Company Clients</h2>
                    </div>
                </div>
                <div className="card ">
                    <figure className="px-10 pt-10">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <h2 className="card-title text-primary">Our Projects</h2>
                    </div>
                </div>
                <div className="card ">
                    <figure className="px-10 pt-10">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <h2 className="card-title text-primary">Positive Feedback</h2>
                    </div>
                </div>
            </div>
        </div>
