    ...
    return (
        <div id='aboutus' className='w-full  px-3 lg:px-32 '>
            ...
            <div className="card-body px-0">
                <h2 className="card-title lg:text-[30px] text-[24px] text-secondary">WELCOME TO <span className='text-primary'>AUTOMANUFAC</span> </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="">
                    <div className="card bg-base-100 rounded-none ">
                        ...
                        <div className="card-body px-0 pt-3 pb-5">
                        ...
                        <div className="card-actions px-0">
                            <button className="btn bg-primary px-6 py-2 rounded-none border-none">Buy Now</button>
                        </div>
                    </div>
                </div>
