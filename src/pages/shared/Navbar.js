      ...
      <div className="navbar bg-zinc-800 pb-0 lg:px-[85px]">
        <div className="navbar-start ">
          <div className="dropdown ">
            ...
            <ul
              tabIndex="0"
              className="menu menu-compact dropdown-content text-white hover:text-primary bg-zinc-600 mt-3 p-2 shadow rounded-box w-52"
            >
              <li>
          ...
          <Link to="/" className="btn btn-ghost text-lg lg:text-xl text-white ">
            AUTO <span className="text-primary text-[30px]">M</span> anufac
          </Link>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal ">
            ...
            {user?.email && (
              <li>
                <CustomLink to="/dashboard" className="">
                  Dashboard
                </CustomLink>
              </li>
            )}
        ...
        <div className="navbar-end">
          <ul className="menu menu-horizontal text-primary p-0">
            {user?.email ? (
              <>
                ...
                <li>
                  <button
                    ...
                    className="bg-none lg:border-2 px-0 py-2 lg:px-3 lg:border-primary text-white"
                  >
                    LOGOUT
                  </button>
                </li>
              ...
              <>
                <li>
                  <Link to="/login" className="uppercase px-0">
                    LOGIN
                  </Link>
                </li>
                <li>
